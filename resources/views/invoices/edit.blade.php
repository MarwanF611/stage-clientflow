                            ...
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <select id="countries"
                                        ...
                                        <option value="21%" {{ $invoice->vat_rate == '21%' ? 'selected' : '' }}>21%
                                        </option>
                                        <option value="12%" {{ $invoice->vat_rate == '12%' ? 'selected' : '' }}>12%
                                        </option>
                                        <option value="6%" {{ $invoice->vat_rate == '6%' ? 'selected' : '' }}>6%
                                        </option>
                                        <option value="0%" {{ $invoice->vat_rate == '0%' ? 'selected' : '' }}>0%
                                        </option>
                                    </select>
